...
> [!NOTE]
> **完全不熟悉 Zotero 或 perma.cc？** 展開下方說明，了解這些工具是什麼、網路引用為何會失效，以及 Bluebook 第 22 版的具體要求。
...
1. 點此下載：**[perma-archiver_v1.2.8.xpi](https://github.com/kirinccchang/zotero-perma-archiver/releases/download/v1.2.8/perma-archiver_v1.2.8.xpi)**
